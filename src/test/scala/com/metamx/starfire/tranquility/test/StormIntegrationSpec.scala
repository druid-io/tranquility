...
import com.metamx.starfire.tranquility.storm.{BeamBolt, BeamFactory}
import com.metamx.starfire.tranquility.test.StormIntegrationSpec.{SimpleKryoFactory, SimpleBeam, SimpleBeamFactory, SimpleEvent}
import com.metamx.starfire.tranquility.test.traits.{StormRequiringSpec, CuratorRequiringSpec}
