...
import com.metamx.starfire.tranquility.beam.{HashPartitionBeam, ClusteredBeam, ClusteredBeamTuning, Beam}
import com.metamx.starfire.tranquility.finagle.{BeamService, FinagleRegistryConfig, FinagleRegistry}
import com.metamx.starfire.tranquility.typeclass.{JsonWriter, Timestamper}
